                        ...
                        <div className='font-poppins flex flex-col gap-[24px]'>
                            ...
                            <div>
                                <form className='flex flex-col gap-[32px]'>
                                    ...
                                    <p className='text-[12px] font-[400] font-poppins text-[#1A1A1A] text-center'>Dont have an account? <Link href="/signup" className='text-[#3059EE] font-[600]'>Sign Up</Link></p>
